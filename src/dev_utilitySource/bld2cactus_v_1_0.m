function bld2cactus_v_1_0(bldfn,outname,normalizedBladeRef,plotFlag)
...
for i=1:numStruts
    for j=1:numNodesPerStrut
        index = index + 1;
        strut{i}.SEx(j) = strutDataBlock(index,6)/refR; #cactus x is vawtgen y
        strut{i}.SEy(j) = strutDataBlock(index,7)/refR; #cactus y is vawtgen z
        strut{i}.SEz(j) = strutDataBlock(index,5)/refR; #cactus z is vawtgen x 
