# ccall((:structuralDynamicsTransient,"structuralDynamicsTransient"),Void,(),model,mesh,el,dispData,Omega_j,OmegaDot_j,t_in,delta_t,elStorage,Fexternal,Fdof,CN2H,rbData,dispOut,FReaction_j)
# elStrain = dispOut.elStrain
# void structuralDynamicsTransient(const char analysisType[3], double
#  turbineStartup, boolean_T usingRotorSpeedFunction, const double tocp[2], const
#  double initCond_data[], const int initCond_size[2], double numTS, double
#  delta_t, const double Omegaocp[2], boolean_T aeroElasticOn, boolean_T
#  aeroForceOn, boolean_T aeroLoadsOn, boolean_T driveTrainOn, double airDensity,
#  double guessFreq, boolean_T gravityOn, boolean_T generatorOn, boolean_T
#  hydroOn, double JgearBox, double gearRatio, double gearBoxEfficiency,
#  boolean_T useGeneratorFunction, double generatorProps, double OmegaGenStart,
#  boolean_T omegaControl, double OmegaInit, double totalNumDof, boolean_T
#  spinUpOn, boolean_T nlOn, double numModesToExtract, const char aeroloadfile[48],
#  const char owensfile[59], const char outFilename[71], double RayleighAlpha,
#  double RayleighBeta, double elementOrder, const double joint[96], double
#  c_platformTurbineConnectionNode, const double jointTransform[206640], const
#  double reducedDOFList[420], double numBlades, const double bladeNum[46], const
#  double h[46], const double nodeNum[46], const double elementNum[46], const
#  double remaining[552], const char iterationType[2], boolean_T
#  adaptiveLoadSteppingFlag, double tolerance, double maxIterations, double
#  maxNumLoadSteps, double minLoadStepDelta, double minLoadStep, double
#  prescribedLoadStep, double numpBC, const double pBC[18], double numsBC, double
#  nummBC, const double isConstrained[492], const double map[420], const double
#  redVectorMap[420], double k, double c, const double nodeNummesh[82], double
#  numEl, double numNodes, const double x[82], const double y[82], const double
#  z[82], const double elNum[75], const double conn[150], const double ac[150],
#  const double twist[150], const double rhoA[150], const double EIyy[150], const
#  double EIzz[150], const double GJ[150], const double EA[150], const double
#  rhoIyy[150], const double rhoIzz[150], const double rhoJ[150], const double
#  zcm[150], const double ycm[150], const double a[150], const double EIyz[150],
#  const double alpha1[150], const double alpha2[150], const double alpha3[150],
#  const double alpha4[150], const double alpha5[150], const double alpha6[150],
#  const double rhoIyz[150], const double b[150], const double a0[150], const
#  double aeroCenterOffset[150], const double elLen[75], const double psi[75],
#  const double theta[75], const double roll[75], const boolean_T
#  rotationalEffects[75], const double displ_s[492], const double displdot_s[492],
#  const double displddot_s[492], double Omega, double OmegaDot, const double
#  K11[300], const double K12[300], const double K13[300], const double K14[300],
#  const double K15[300], const double K16[300], const double K22[300], const
#  double K23[300], const double K24[300], const double K25[300], const double
#  K26[300], const double K33[300], const double K34[300], const double K35[300],
#  const double K36[300], const double K44[300], const double K45[300], const
#  double K46[300], const double K55[300], const double K56[300], const double
#  K66[300], const double M11[300], const double M15[300], const double M16[300],
#  const double M22[300], const double M24[300], const double M33[300], const
#  double M34[300], const double M44[300], const double M55[300], const double
#  M56[300], const double M66[300], const double S11[300], const double S12[300],
#  const double S13[300], const double S15[300], const double S16[300], const
#  double S22[300], const double S23[300], const double S25[300], const double
#  S26[300], const double S33[300], const double S35[300], const double S36[300],
#  const double S55[300], const double S56[300], const double S66[300], const
#  double S14_1[300], const double S14_2[300], const double S24_1[300], const
#  double S24_2[300], const double S34_1[300], const double S34_2[300], const
#  double S45_1[300], const double S45_2[300], const double S46_1[300], const
#  double S46_2[300], const double S44_1[300], const double S44_2[300], const
#  double S44_3[300], const double C12[300], const double C13[300], const double
#  C23[300], const double C24[300], const double C25[300], const double C26[300],
#  const double C34[300], const double C35[300], const double C36[300], const
#  double C14_1[300], const double C14_2[300], const double C45_1[300], const
#  double C45_2[300], const double C46_1[300], const double C46_2[300], const
#  double mel[75], const double moiel[675], const double xmel[225], const double
#  Fexternal[273], const double Fdof[273], const double CN2H[9], const double
#  rbData[9], struct0_T *dispOut, emxArray_real_T *eps_xx_0, emxArray_real_T
#  *eps_xx_z, emxArray_real_T *eps_xx_y, emxArray_real_T *gam_xz_0,
#  emxArray_real_T *gam_xz_y, emxArray_real_T *gam_xy_0, emxArray_real_T
#  *gam_xy_z, double FReaction_sp1[6])
...
(typeof(analysisType),
typeof(turbineStartup),
typeof(usingRotorSpeedFunction),
Ptr{typeof(tocp)},
Ptr{typeof(initCond)},
typeof(numTS),
typeof(delta_t),
Ptr{typeof(Omegaocp)},
typeof(aeroElasticOn),
typeof(aeroForceOn),
typeof(aeroLoadsOn),
typeof(driveTrainOn),
typeof(airDensity),
...
typeof(JgearBox),
typeof(gearRatio),
typeof(gearBoxEfficiency),
typeof(useGeneratorFunction),
typeof(generatorProps),
typeof(OmegaGenStart),
typeof(omegaControl),
typeof(OmegaInit),
typeof(totalNumDof),
typeof(spinUpOn),
typeof(nlOn),
typeof(numModesToExtract),
typeof(aeroloadfile),
typeof(owensfile),
typeof(outFilename),
typeof(RayleighAlpha),
typeof(RayleighBeta),
typeof(elementOrder),
Ptr{typeof(joint)},
typeof(platformTurbineConnectionNodeNumber),
Ptr{typeof(jointTransform)},
Ptr{typeof(reducedDOFList)},
typeof(numBlades),
Ptr{typeof(bladeNum)},
Ptr{typeof(h)},
Ptr{typeof(nodeNum)},
Ptr{typeof(elementNum)},
Ptr{typeof(remaining)},
typeof(iterationType),
typeof(adaptiveLoadSteppingFlag),
typeof(tolerance),
typeof(maxIterations),
typeof(maxNumLoadSteps),
typeof(minLoadStepDelta),
typeof(minLoadStep),
Ptr{typeof(prescribedLoadStep)},
typeof(numpBC),
Ptr{typeof(pBC)},
typeof(numsBC),
typeof(nummBC),
Ptr{typeof(isConstrained)},
Ptr{typeof(map)},
Ptr{typeof(redVectorMap)},
Ptr{typeof(concLoad)},
Ptr{typeof(concStiff)},
Ptr{typeof(concMass)},
Ptr{typeof(concStiffGen)},
Ptr{typeof(concMassGen)},
Ptr{typeof(concDampGen)},
typeof(k),
typeof(c),
Ptr{typeof(nodeNummesh)},
typeof(numEl),
typeof(numNodes),
Ptr{typeof(x)},
Ptr{typeof(y)},
...
Ptr{typeof(b)},
Ptr{typeof(a0)},
Ptr{typeof(aeroCenterOffset)},
Ptr{typeof(elLen)},
Ptr{typeof(psi)},
Ptr{typeof(theta)},
Ptr{typeof(roll)},
Ptr{typeof(rotationalEffects)},
Ptr{typeof(displ_s)},
Ptr{typeof(displdot_s)},
Ptr{typeof(displddot_s)},
typeof(Omega_j),
typeof(OmegaDot_j),
Ptr{typeof(K11)},
Ptr{typeof(K12)},
...
Ptr{typeof(moiel)},
Ptr{typeof(xmel)},
Ptr{typeof(Fexternal)},
Ptr{typeof(Fdof)},
Ptr{typeof(CN2H)},
Ptr{typeof(rbData)},
Ptr{typeof(displ_sp1)},
Ptr{typeof(displddot_sp1)},
Ptr{typeof(displdot_sp1)},
Ptr{typeof(eps_xx_0)},
Ptr{typeof(eps_xx_z)},
Ptr{typeof(eps_xx_y)},
Ptr{typeof(gam_xz_0)},
...
# mat"""
# [$displ_sp1,$displddot_sp1,$displdot_sp1,$eps_xx_0,$eps_xx_z,$eps_xx_y,$gam_xz_0,$gam_xz_y,$gam_xy_0,$gam_xy_z,$FReaction_j] = structuralDynamicsTransient($analysisType,...
# $turbineStartup,...
# $usingRotorSpeedFunction,...
# $tocp,...
# $initCond,...
...
for jj = 1:mesh.numEl
    elStrain[jj] =  ElStrain(eps_xx_0[jj,:], eps_xx_z[jj,:], eps_xx_y[jj,:], gam_xz_0[jj,:], gam_xz_y[jj,:], gam_xy_0[jj,:], gam_xy_z[jj,:])
end
