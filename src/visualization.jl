...
#Input
* `mesh::GyricFEA.Mesh`:    Mesh struct, See ?GyricFEA.Mesh
...
None
"""
function viz(PyPlot;mesh=[],meshFile="none",resultsFile="none",selectedMode=10,sf=10,
    freq=nothing,damp=nothing,U_x_0=nothing,U_y_0=nothing,U_z_0=nothing,
    theta_x_0=nothing,theta_y_0=nothing,theta_z_0=nothing,U_x_90=nothing,
    U_y_90=nothing,U_z_90=nothing,theta_x_90=nothing,theta_y_90=nothing,
...
function plotMesh(mesh,colorstring,meshSeg,ax1,ax2,ax3,ax4)
    ...
    for i=1:length(meshSeg) #loop over mesh segments
        ...
        ax4.set_xlabel("h_1"); ax4.set_ylabel("h_2"); ax4.set_zlabel("h_3")
