function  [elStrain,dispOut,FReaction_sp1] = structuralDynamicsTransient(model,mesh,el,dispData,Omega,OmegaDot,~,delta_t,elStorage,Fexternal,Fdof,CN2H,rbData)
