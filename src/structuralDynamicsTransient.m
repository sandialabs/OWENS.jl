function  [displ_sp1,displddot_sp1,displdot_sp1,eps_xx_0,eps_xx_z,eps_xx_y,gam_xz_0,gam_xz_y,gam_xy_0,gam_xy_z,FReaction_sp1] = structuralDynamicsTransient(concLoad,...
concStiff,...
concMass,...
concStiffGen,...
concMassGen,...
...
rbData)
      ...
      while(unorm>tol && iterationCount < maxIterations) %iteration loop
            ...
            for i=1:numEl
                  ...
                  fprintf('Line 758 Run Successfull \n');
                  ...
                  fprintf('Line 788 Run Successfull \n');
