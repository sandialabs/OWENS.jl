...
concStiffGen = [];
for ii = 1:6
      concStiffGennodeNum(ii) = 1.0;
      concStiffGendof1(ii) = 1.0;
      concStiffGendof2(ii) = 1.0;
      concStiffGenval(ii) = 1.0;
end

concMassGen = [];
for ii = 1:6
      concMassGennodeNum(ii) = 1.0;
      concMassGendof1(ii) = 1.0;
      concMassGendof2(ii) = 1.0;
      concMassGenval(ii) = 1.0;
end

concDampGen = [];
for ii = 1:6
      concDampGennodeNum(ii) = 1.0;
      concDampGendof1(ii) = 1.0;
      concDampGendof2(ii) = 1.0;
      concDampGenval(ii) = 1.0;
end
