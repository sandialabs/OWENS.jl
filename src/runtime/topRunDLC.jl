# Import the core modeling options and DLC analysis functionality
include("../core/ModelingOptions.jl")
include("DLCAnalysis.jl")
...
export MasterInput, OWENS_Options, DLC_Options, OWENSAero_Options, OWENSFEA_Options, 
       ...
       ModelingOptions, Design_Data, runOWENS, runDLC, getDLCparams, generateUniformwind, 
       generateTurbsimBTS, getGustVel, simpleGustVel, DLC_internal
