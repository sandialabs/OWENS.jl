...
extern void fminbnd(double c_funfcnInput_tunableEnvironmen, const char
                    ...
                    *r_funfcnInput_tunableEnvironmen, const c_emxArray_struct_T *
                    s_funfcnInput_tunableEnvironmen, double bx, double *xf,
                    double *fval, double *exitflag, double *output_iterations,
