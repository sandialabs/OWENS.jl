function  [dispOut,FReaction_sp1] = structuralDynamicsTransientROM(model,mesh,el,dispData,Omega,OmegaDot,time,delta_t,elStorage,rom,Fexternal,Fdof,CN2H,rbData)
