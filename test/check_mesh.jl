...
precompoutput,precompinput = OWENS.getOWENSPreCompOutput(numadIn;plyprops)
sectionPropsArray_twr = OWENS.getSectPropsFromOWENSPreComp(mymesh.z[1:24],numadIn,precompoutput)
...
bld_precompoutput,bld_precompinput = OWENS.getOWENSPreCompOutput(numadIn_bld;plyprops)
newspan = mymesh.z[25:46].-15.0
newspan = newspan./maximum(newspan)
sectionPropsArray_bld = OWENS.getSectPropsFromOWENSPreComp(newspan,numadIn_bld,bld_precompoutput) #TODO: why is this not aligning?
...
# Check File Io
sectionPropsArray_bld2 = OWENS.getSectPropsFromOWENSPreComp(mymesh.z[25:47].-15.0,numadIn_bld,bld_precompoutput)
