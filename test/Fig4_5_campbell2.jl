...
system, assembly, sections, frames, points, start, stop = ModelGen.owens_to_gx(mymesh,myort,myjoint,sectionPropsArray,mass_twr, mass_bld, stiff_twr, stiff_bld;damp_coef=0.0,VTKmeshfilename="$path/vtk/SNL34m")
