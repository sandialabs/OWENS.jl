...
static void emxExpand_struct_T2(e_emxArray_struct_T *emxArray, int fromIndex,
  int toIndex);
static void emxFree_struct_T2(c_emxArray_struct_T **pEmxArray);
static void emxInit_struct_T2(c_emxArray_struct_T **pEmxArray, int numDimensions);
...
// Return Type  : void
//
void emxCopyStruct_struct_T1(m_struct_T *dst, const m_struct_T *src)
{
  dst->NElem = src->NElem;
  dst->TtoC = src->TtoC;
...
// Return Type  : void
//
void emxCopyStruct_struct_T2(l_struct_T *dst, const l_struct_T *src)
{
...
void emxEnsureCapacity_struct_T(emxArray_struct_T *emxArray, int oldNumel)
{
  ...
  if (newNumel > emxArray->allocatedSize) {
    ...
    newData = std::calloc(static_cast<unsigned int>(i), sizeof(d_struct_T));
    if (emxArray->data != NULL) {
      std::memcpy(newData, emxArray->data, sizeof(d_struct_T) * oldNumel);
      if (emxArray->canFreeData) {
        std::free(emxArray->data);
      }
    }
...
// Return Type  : void
//
void emxEnsureCapacity_struct_T1(d_emxArray_struct_T *emxArray, int oldNumel)
{
  int newNumel;
  int i;
  void *newData;
  ...
  if (newNumel > emxArray->allocatedSize) {
    ...
    newData = std::calloc(static_cast<unsigned int>(i), sizeof(k_struct_T));
    if (emxArray->data != NULL) {
      std::memcpy(newData, emxArray->data, sizeof(k_struct_T) * oldNumel);
      if (emxArray->canFreeData) {
        std::free(emxArray->data);
      }
    }
...
// Return Type  : void
//
void emxEnsureCapacity_struct_T2(f_emxArray_struct_T *emxArray, int oldNumel)
{
  int newNumel;
  int i;
  void *newData;
...
// Return Type  : void
//
void emxEnsureCapacity_struct_T3(e_emxArray_struct_T *emxArray, int oldNumel)
{
  int newNumel;
  int i;
  void *newData;
...
// Return Type  : void
//
void emxEnsureCapacity_struct_T4(b_emxArray_struct_T *emxArray, int oldNumel)
{
  int newNumel;
  int i;
  void *newData;
...
// Return Type  : void
//
void emxFreeStruct_struct_T2(i_struct_T *pStruct)
{
...
// Return Type  : void
//
void emxFreeStruct_struct_T3(j_struct_T *pStruct)
{
  emxFree_struct_T2(&pStruct->elStrain);
...
// Return Type  : void
//
void emxFreeStruct_struct_T4(k_struct_T *pStruct)
{
...
// Return Type  : void
//
void emxFreeStruct_struct_T5(l_struct_T *pStruct)
{
...
// Return Type  : void
//
void emxInitStruct_struct_T2(i_struct_T *pStruct)
{
...
// Return Type  : void
//
void emxInitStruct_struct_T3(j_struct_T *pStruct)
{
  emxInit_struct_T2(&pStruct->elStrain, 2);
...
// Return Type  : void
//
void emxInitStruct_struct_T5(k_struct_T *pStruct)
{
