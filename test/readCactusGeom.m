...
NBlade = processLine(fid);
[cactusGeom.NBlade] = NBlade;
NStrut = processLine(fid);
[cactusGeom.NStrut] = NStrut;
...
cactusGeom.blade = repmat(blade,1,NBlade);

strut = struct('NElem',zeros,...
'TtoC',zeros,...
'MCx',zeros,...
'MCy',zeros,...
'MCz',zeros,...
...
cactusGeom.strut = repmat(strut,1,NStrut);
