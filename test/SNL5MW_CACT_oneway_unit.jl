...
function test_owens(test_transient,test_modal,test_flutter)
    ...
    platformProp = PlatformProp("$path/data/1_FourColumnSemi_2ndPass",
...
#
#     for df = 1:Ndof
#         PrePostOWENS.viz("$path/data/_15mTower_transient_dvawt_c_2_lcdt.mesh",new_filename,df,10)
...
#
#     for df = 1:Ndof
#         PrePostOWENS.viz("$path/data/_15mTower_transient_dvawt_c_2_lcdt.mesh",old_filename,df,10)
#         if savePlot # save the plot
