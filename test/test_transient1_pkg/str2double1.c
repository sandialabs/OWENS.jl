  ...
  if (*success) {
    ...
    if (isneg) {
      if (allowimag) {
        *isimag = true;
        (*k)++;
        while ((*k <= 1) && (bv[(unsigned char)s & 127] || (s == '\x00') || (s ==
                 ','))) {
          *k = 2;
        }
  ...
  if (*success) {
    ...
    if (guard1) {
      ...
      *k = b_k;
      ...
      exitg1 = false;
      while ((!exitg1) && (*k <= n)) {
        if (bv[(unsigned char)s->data[*k - 1] & 127]) {
          (*k)++;
        } else {
          c_idx_0 = s->data[*k - 1];
      ...
      if ((*k <= n) && (s->data[*k - 1] == '*')) {
        (*k)++;
        while ((*k <= n) && (bv[(unsigned char)s->data[*k - 1] & 127] ||
  ...
  *foundsign = false;
  ...
  while ((!exitg1) && (*k <= n)) {
    if (s->data[*k - 1] == '-') {
      ...
      *foundsign = true;
      (*k)++;
    } else if (!bv[(unsigned char)s->data[*k - 1] & 127]) {
      exitg1 = true;
    } else {
      (*k)++;
    }
  ...
  if (*success) {
    ...
    if (guard1) {
      ...
      *k = b_k;
      ...
      while ((*k <= n) && (bv[(unsigned char)s->data[*k - 1] & 127] || (s->data[*
               k - 1] == '\x00') || (s->data[*k - 1] == ','))) {
        (*k)++;
      }
    ...
    while ((*k <= n) && (bv[(unsigned char)s->data[*k - 1] & 127] || (s->data[*k
             - 1] == '\x00') || (s->data[*k - 1] == ','))) {
      (*k)++;
    }
  }
    ...
    if (isneg) {
      if (allowimag) {
        *isimag = true;
        ...
        while ((!exitg1) && (*k <= 2)) {
          p_tmp = s[*k - 1];
          if (bv[(unsigned char)p_tmp & 127] || (p_tmp == '\x00') || (p_tmp ==
               ',')) {
            (*k)++;
          } else {
            exitg1 = true;
      ...
      if ((*k <= 2) && (s[*k - 1] == '*')) {
        (*k)++;
        while ((*k <= 2) && (bv[(unsigned char)s[*k - 1] & 127] || (s[*k - 1] ==
                 '\x00') || (s[*k - 1] == ','))) {
          (*k)++;
        }
      }
