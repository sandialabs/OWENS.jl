/*
 * File: ConcMassAssociatedWithElement.c
 *
  ...
  *joint, double mass[8])
{
  ...
  if (joint->size[0] > 0) {
    ...
    for (loop_ub = 0; loop_ub <= i; loop_ub++) {
      ...
      if ((fabs(node1 - joint->data[loop_ub + joint->size[0]]) < absx) ||
    ...
    for (loop_ub = 0; loop_ub <= i; loop_ub++) {
      ...
      if ((fabs(node2 - joint->data[loop_ub + joint->size[0]]) < absx) ||
...
/*
 * File trailer for ConcMassAssociatedWithElement.c
 *
 * [EOF]
 */
