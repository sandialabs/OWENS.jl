...
void transientExec(const char model_analysisType[3], const double model_tocp[2],
                   ...
                   *model_jointTransform, const e_struct_T mesh, const
                   f_struct_T el)
{
  ...
  platNorm = (int)(mesh.numNodes * 6.0);
  i = u_s->size[0];
  u_s->size[0] = platNorm;
  ...
  memset(&t_data[0], 0, 51U * sizeof(double));
  memset(&FReactionHist_data[0], 0, 306U * sizeof(double));
  ...
  memset(&aziHist_data[0], 0, 51U * sizeof(double));
  memset(&OmegaHist_data[0], 0, 51U * sizeof(double));
  memset(&OmegaDotHist_data[0], 0, 51U * sizeof(double));
  memset(&gbHist_data[0], 0, 51U * sizeof(double));
  memset(&gbDotHist_data[0], 0, 51U * sizeof(double));
  memset(&genPower_data[0], 0, 51U * sizeof(double));
  t_data[0] = 0.0;
  ...
  while ((!exitg1) && (b_i - 1 < 50)) {
    ...
    if (terminateSimulation) {
      ...
      while (((uNorm > 1.0E-8) || (platNorm > 1.0E-8) || (aziNorm > 1.0E-8) ||
          ...
          for (i = 0; i < 3; i++) {
            ...
            for (platNorm = 0; platNorm < 3; platNorm++) {
              b_CP2H_tmp[i + 3 * platNorm] = (CP2H_tmp[i] * structureMOI[3 *
                platNorm] + aziNorm * structureMOI[3 * platNorm + 1]) + (double)
                i1 * structureMOI[3 * platNorm + 2];
            }
          }
        ...
        aziNorm = fabs(azi_j - gb_s) / fabs(azi_j);
  ...
  if (0 <= loop_ub - 4) {
    memcpy(&b_model_outFilename_data[0], &model_outFilename_data[0], (loop_ub +
            -3) * sizeof(char));
  }
  ...
  for (b_i = 0; b_i < 52; b_i++) {
    if (b_i == 0) {
      ...
      b_sprintf(OmegaHist_data[b_i - 1], r2);
      ...
      i = line->size[0] * line->size[1];
      line->size[0] = 1;
      line->size[1] = ((((((((((((((((b_r->size[1] + b_r1->size[1]) + r2->size[1])
        + r3->size[1]) + r4->size[1]) + r5->size[1]) + r6->size[1]) + r7->size[1])
        + r8->size[1]) + r9->size[1]) + r10->size[1]) + r11->size[1]) +
      ...
      loop_ub = r2->size[1];
      for (i = 0; i < loop_ub; i++) {
        line->data[((i + b_r->size[1]) + b_r1->size[1]) + 2] = r2->data[i];
      }

      line->data[((b_r->size[1] + b_r1->size[1]) + r2->size[1]) + 2] = ',';
      loop_ub = r3->size[1];
      for (i = 0; i < loop_ub; i++) {
        line->data[(((i + b_r->size[1]) + b_r1->size[1]) + r2->size[1]) + 3] =
          r3->data[i];
      }

      line->data[(((b_r->size[1] + b_r1->size[1]) + r2->size[1]) + r3->size[1])
        + 3] = ',';
      loop_ub = r4->size[1];
      for (i = 0; i < loop_ub; i++) {
        line->data[((((i + b_r->size[1]) + b_r1->size[1]) + r2->size[1]) +
      ...
      line->data[((((((b_r->size[1] + b_r1->size[1]) + r2->size[1]) + r3->size[1])
                    + r4->size[1]) + r5->size[1]) + r6->size[1]) + 6] = ',';
      loop_ub = r7->size[1];
      for (i = 0; i < loop_ub; i++) {
        line->data[(((((((i + b_r->size[1]) + b_r1->size[1]) + r2->size[1]) +
      ...
      line->data[(((((((b_r->size[1] + b_r1->size[1]) + r2->size[1]) + r3->size
                      [1]) + r4->size[1]) + r5->size[1]) + r6->size[1]) +
                  r7->size[1]) + 7] = ',';
      loop_ub = r8->size[1];
      for (i = 0; i < loop_ub; i++) {
        line->data[((((((((i + b_r->size[1]) + b_r1->size[1]) + r2->size[1]) +
      ...
      line->data[((((((((b_r->size[1] + b_r1->size[1]) + r2->size[1]) + r3->
                       size[1]) + r4->size[1]) + r5->size[1]) + r6->size[1]) +
                   r7->size[1]) + r8->size[1]) + 8] = ',';
      loop_ub = r9->size[1];
      for (i = 0; i < loop_ub; i++) {
        line->data[(((((((((i + b_r->size[1]) + b_r1->size[1]) + r2->size[1]) +
                         r3->size[1]) + r4->size[1]) + r5->size[1]) + r6->size[1])
                     + r7->size[1]) + r8->size[1]) + 9] = r9->data[i];
      }

      line->data[(((((((((b_r->size[1] + b_r1->size[1]) + r2->size[1]) +
                        r3->size[1]) + r4->size[1]) + r5->size[1]) + r6->size[1])
      ...
      for (i = 0; i < loop_ub; i++) {
        line->data[((((((((((i + b_r->size[1]) + b_r1->size[1]) + r2->size[1]) +
                       ...
                       [1]) + r7->size[1]) + r8->size[1]) + r9->size[1]) + 10] =
          r10->data[i];
      }
      ...
      loop_ub = r16->size[1];
      for (i = 0; i < loop_ub; i++) {
        line->data[(((((((((((i + (((((b_r->size[1] + b_r1->size[1]) + r2->size
          [1]) + r3->size[1]) + r4->size[1]) + r5->size[1])) + r6->size[1]) +
                            r7->size[1]) + r8->size[1]) + r9->size[1]) +
                         r10->size[1]) + r11->size[1]) + r12->size[1]) +
                      r13->size[1]) + r14->size[1]) + r15->size[1]) + 16] =
          r16->data[i];
      }
    ...
    b_fwrite(input_sizes_idx_0, line);
  }
  ...
  if (0 <= loop_ub - 1) {
    memcpy(&d_model_outFilename_data[0], &model_outFilename_data[0], loop_ub *
           sizeof(char));
  }
  ...
  if (0 <= loop_ub - 1) {
    memcpy(&f_model_outFilename_data[0], &model_outFilename_data[0], loop_ub *
           sizeof(char));
  }
  ...
  for (b_i = 0; b_i < 51; b_i++) {
    if (b_i == 0) {
      d_fwrite(input_sizes_idx_0);
      b_sprintf(51.0, b_r);
      b_sprintf(strainHist->size[0], b_r1);
      i = line->size[0] * line->size[1];
      line->size[0] = 1;
      line->size[1] = (b_r->size[1] + b_r1->size[1]) + 2;
      emxEnsureCapacity_char_T(line, i);
      ...
      for (platNorm = 0; platNorm <= i; platNorm++) {
        e_fwrite(input_sizes_idx_0);
        b_sprintf(t_data[b_i - 1], b_r);
        b_sprintf((double)platNorm + 1.0, b_r1);
        i1 = line->size[0] * line->size[1];
        line->size[0] = 1;
        line->size[1] = (b_r->size[1] + b_r1->size[1]) + 2;
        emxEnsureCapacity_char_T(line, i1);
...
/*
 * File trailer for transientExec.c
 *
 * [EOF]
 */
