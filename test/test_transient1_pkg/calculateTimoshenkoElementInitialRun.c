/*
 * File: calculateTimoshenkoElementInitialRun.c
 *
  ...
  input_concMassFlag, const double input_concMass[8], d_struct_T *elStorage)
{
  ...
  C46_2_idx_3 = 0.0;
  elementMass = 0.0;
  memset(&elementItens[0], 0, 9U * sizeof(double));
  elxm[0] = 0.0;
  elxm[1] = 0.0;
  elxm[2] = 0.0;
  ...
  memcpy(&elStorage->moiel[0], &elementItens[0], 9U * sizeof(double));
...
/*
 * File trailer for calculateTimoshenkoElementInitialRun.c
 *
 * [EOF]
 */
