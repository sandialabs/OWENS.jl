...
outfile_root="owens_wn_prescribed_20240802"
potflowfile = "$path/potential_flow_data/marin_semi"
hd_input_file = "$path/HydroDyn_CCT2_test.dat"
md_input_file = "$path/MoorDyn_CCT2_test.dat"
ss_input_file = "$path/NRELOffshrBsline5MW_OC4DeepCwindSemi_SeaState.dat"
hd_lib = "/Users/kevmoor/Documents/coderepos/openfast/build/modules/hydrodyn/libhydrodyn_c_binding" #"$path/bin/HydroDyn_c_binding_x64.old"
md_lib = "/Users/kevmoor/Documents/coderepos/openfast/build/modules/moordyn/libmoordyn_c_binding"  #"$path/bin/MoorDyn_c_binding_x64.old"
bcDOFs = []
moordyn_on = true
...
aeroloadfile = "$path/data/DVAWT_2B_LCDT_ElementData.csv",
owensfile = "$path/data/_NREL5MW_transient.owens",
...
topForcingFile = "$(path)/PrescribedForcesMoments.csv"
...
# runSim(outfile_root="owens_wn_prescribed_20240802",
#     potflowfile = "$path/potential_flow_data/marin_semi",
#     hd_input_file = "$path/HydroDyn_CCT2_test.dat",
#     md_input_file = "$path/MoorDyn_CCT2_test.dat",
#     ss_input_file = "$path/NRELOffshrBsline5MW_OC4DeepCwindSemi_SeaState.dat",
