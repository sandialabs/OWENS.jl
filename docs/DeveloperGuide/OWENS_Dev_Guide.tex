...
%As for the gimbal lock case, it is an arbitrary decision to set either yaw or roll to zero, then calculate the other. It should make no difference whatsoever which is chosen, but the case does need to be explicitly handled.  I made some changes to the code for this and pushed it (meshing utilities.jl in ModelGen.  I think this should handle any number of blades now.
